...
<html lang="en">
	<head>
	    ...
	    <title>Portal de Compras Página Principal</title>
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Garantía de devolución de dinero de 30 días.

					</h6>
					<div class="qr-code">
					<img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=smsto:+1234567890?body=EL%20MEJOR%20TRATO%20LO%20TIENES%20TU" alt="QR Code">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Envíos gratis a partir de $1000
					<div class="qr-code">
					<img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=smsto:+1234567890?body=POR%20QUE%20tu%20te%20lo%20mereces" alt="QR Code">
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Todos los articulos al 20& de descuento</h6>	
					<div class="qr-code">
					<img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=smsto:+1234567890?body=LAS%20MEJORES%20OFERTAS" alt="QR Code">
...
<style>
    ...
    margin: 20px 0; /* Añade un poco de margen superior e inferior si es necesario */
}
</style>