	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Producto entregado exitosamente</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<span class="title-tag inner-top-vs">Por favor, ingresa tu ID de pedido en el cuadro de abajo y presiona Enter. Este se te proporcionó en tu recibo y en el correo electrónico de confirmación que debiste haber recibido. </span>
	<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleBillingEmail1">Registrar Email</label>
