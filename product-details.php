...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Cargo de envío :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Calidad :</b>  <?php echo htmlentities($rvw['quality']);?> Calificación</div>
													<div class="text"><b>Precio :</b>  <?php echo htmlentities($rvw['price']);?> Calificación</div>
													<div class="text"><b>valor :</b>  <?php echo htmlentities($rvw['value']);?> Calificación</div>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">Encuesta <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">SUBIR REVIEW</button>
														</div><!-- /.action -->
