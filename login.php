...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="Invalido email o contraseña";
exit();
}
}
...
<html lang="en">
	<head>
	    ...
	    <title>Shopping Portal | Iniciar Sesión | Registrar</title>
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">Entrar</h4>
	<p class="">Hola, bienvenido de nuevo</p>
