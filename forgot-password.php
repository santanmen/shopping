...
$_SESSION['errmsg']="Contraseña cambiada correctamente";
exit();
}
else
{
...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="Invalido email de contacto";
exit();
}
}
...
<html lang="en">
	<head>
	    ...
	    <title>Portal de compras | Recuperación de contraseña</title>
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">Olvidaste la contraseña</h4>
...
<div class="form-group">
	    	<label class="info-title" for="confirmpassword">Repetir contraseña <span>*</span></label>
