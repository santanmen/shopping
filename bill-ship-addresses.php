	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	          <span>1</span>Facturación dirección
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Facturación dirección<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Facturación Estado  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Facturación Ciudad <span>*</span></label>
...
?>
					...
					<form class="register-form" role="form" method="post">
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Dirección de envió<span>*</span></label>
